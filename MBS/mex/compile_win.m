...
% set the values
opts.opencv_include_path    =   'D:\Program Files\opencv_2.4.9\opencv\build\include'; % OpenCV include path
opts.opencv_lib_path        =   'D:\Program Files\opencv_2.4.9\opencv\build\x64\vc12\lib'; % OpenCV lib path
